...
class FuelSavings(BaseModel):
    ...
    """ # noqa: E501
    baseline: ImpactMetric = Field(description="The estimates under the baseline scenario.")
    upgrade: Optional[ImpactMetric] = Field(default=None, description="The estimates under the upgrade scenario if passed.")
    delta: Optional[ImpactMetric] = Field(default=None, description="The savings estimates (difference between baseline and upgrade) under the upgrade scenario if passed.")
