...
class RemProfileRequest(BaseModel):
    ...
    water_heater_fuel: Optional[WaterHeaterFuel] = None
    ...
    __properties: ClassVar[List[str]] = ["upgrade", "heating_fuel", "water_heater_fuel", "building_profile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if water_heater_fuel (nullable) is None
        # and model_fields_set contains the field
        if self.water_heater_fuel is None and "water_heater_fuel" in self.model_fields_set:
            _dict['water_heater_fuel'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "water_heater_fuel": obj.get("water_heater_fuel"),
