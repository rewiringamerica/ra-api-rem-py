...
class BuildingProfilerApi:
    ...
    @validate_call
    def building_profiler_get_home_profile(
        self,
        ...
        _param = self._building_profiler_get_home_profile_serialize(
            address=address,
    ...
    @validate_call
    def building_profiler_get_home_profile_with_http_info(
        self,
        address: Annotated[str, Field(min_length=1, strict=True, description="The location of a home.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def building_profiler_get_home_profile_without_preload_content(
        self,
        address: Annotated[str, Field(min_length=1, strict=True, description="The location of a home.")],
        _request_timeout: Union[
            None,
    ...
    def _building_profiler_get_home_profile_serialize(
        self,
        address,
        _request_auth,
        _content_type,
